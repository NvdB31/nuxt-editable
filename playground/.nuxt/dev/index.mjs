...
import { renderToString } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/nickvandenberg/Development/nuxt-editable/playground/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/nickvandenberg/Development/nuxt-editable/playground/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/nickvandenberg/Development/nuxt-editable/playground","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/nickvandenberg/Development/nuxt-editable/playground/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/nickvandenberg/Development/nuxt-editable/playground/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/nickvandenberg/Development/nuxt-editable/playground/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/nickvandenberg/Development/nuxt-editable/playground/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _QTIrD1WQPO = (function(nitro) {
...
const _nczRaeocFP = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _pt3gDTDlXZ = defineNitroPlugin(async () => {
...
var SchemaFieldType = /* @__PURE__ */ ((SchemaFieldType2) => {
  SchemaFieldType2["text"] = "string";
  SchemaFieldType2["multiline-text"] = "string";
  SchemaFieldType2["number"] = "number";
  SchemaFieldType2["richText"] = "string";
  SchemaFieldType2["image"] = "string";
  SchemaFieldType2["file"] = "string";
  SchemaFieldType2["url"] = "string";
  SchemaFieldType2["date"] = "date";
  SchemaFieldType2["datetime"] = "date";
  SchemaFieldType2["options"] = "array";
  SchemaFieldType2["switch"] = "boolean";
  SchemaFieldType2["email"] = "string";
  SchemaFieldType2["phone"] = "string";
  SchemaFieldType2["rich-text"] = "string";
  SchemaFieldType2["password"] = "string";
  return SchemaFieldType2;
})(SchemaFieldType || {});
const convertSchemaTypes = (schemaObject) => {
...
const config = useRuntimeConfig();
const models = Object.entries(config.editable.collections).reduce((acc, [key, collection]) => {
...
const getClientManifest = () => import('file:///Users/nickvandenberg/Development/nuxt-editable/playground/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/nickvandenberg/Development/nuxt-editable/playground/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
