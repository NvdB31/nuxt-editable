import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, shallowRef, provide, createElementBlock, useSSRContext, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-DdqlDjWD.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-CKJU8lIM.js").then((r) => r.default));
const lazyGlobalComponents = [
  ["Icon", LazyIcon],
  ["IconCSS", LazyIconCSS]
];
const components_plugin_U6aJKf0Hue = /* @__PURE__ */ defineNuxtPlugin({
...
const modals_92P3Dz9pl5 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const colors_FOK8M1Fquu = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_server_MmBxSP8cZ8 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a;
...
const useEditor = () => {
  ...
  const collections = config2.public.editable.collections;
  ...
  return {
    ...
    collections,
    ui: config2.public.editable.ui,
    log: (event) => {
      if (config2.public.editable.log !== true || event.severity !== config2.public.editable.log)
        return;
...
const plugins = [
  ...
  components_plugin_U6aJKf0Hue,
  modals_92P3Dz9pl5,
  colors_FOK8M1Fquu,
  plugin_server_MmBxSP8cZ8,
  plugin_OO39UYoBgJ
];
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__file", "/Users/nickvandenberg/Development/nuxt-editable/test/fixtures/basic/app.vue"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-9nZ-gW-c.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-q-MA4nLJ.js").then((r) => r.default || r));
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/Users/nickvandenberg/Development/nuxt-editable/node_modules/nuxt/dist/app/components/nuxt-error-page.vue"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-tkIgBK4h.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/nickvandenberg/Development/nuxt-editable/node_modules/nuxt/dist/app/components/nuxt-root.vue"]]);
let entry;
{
