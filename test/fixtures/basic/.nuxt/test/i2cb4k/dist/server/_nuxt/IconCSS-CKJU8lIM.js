  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--2c105f6c-iconUrl": iconUrl.value
      } };
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: sSize.value, height: sSize.value }
      }, _attrs, _cssVars))} data-v-2c105f6c></span>`);
    };
  }
});
...
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2c105f6c"], ["__file", "/Users/nickvandenberg/Development/nuxt-editable/node_modules/nuxt-icon/dist/runtime/IconCSS.vue"]]);
export {
  IconCSS as default
};
//# sourceMappingURL=IconCSS-CKJU8lIM.js.map
